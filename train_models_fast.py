"""
Fast training script for signal classification models
Uses subset of data for quick results generation
"""
...
def load_dataset_subset(dataset_path, subset_size=30000):
    ...
    print(f"Dataset subset loaded: X shape={X.shape}, y shape={y.shape}")
...
def main():
    ...
    # Load dataset subset
    X, y, snr, dataset = load_dataset_subset(dataset_path, subset_size=30000)
